...
built-in ROLE_ALLOW constants). MD/GM are always full-access."""
from .constants import ROLE_ALLOW, ROLE_GM, ROLE_MD

PROTECTED = {ROLE_MD, ROLE_GM}  # always "*", never editable
